...
from sensor.config import SAMPLE_RATE, SUPPORTED_SAMPLE_TYPES, USE_SIMULATED_DATA
from sensor import generate_dataset
...
def get_dataloader():
    x, seg_indexs, _ = generate_dataset(
        DATASET_LENGTH,
        TIME_SERIES_LENGTH,
